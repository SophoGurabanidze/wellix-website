  ...
  return (
    <nav className="bg-primary text-gray-300 p-4 shadow-md relative">
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="text-2xl font-bold text-gray-100"><img src={wellixLogo} alt="Wellix Logo" className="h-[6.5rem]" />
        </Link>
        ...
        <li className="relative group" onMouseEnter={() => handleMouseEnter("about")} onMouseLeave={handleMouseLeave}> 
          <Link to="/" className="hover:underline decoration-sky-700 decoration-2 underline-offset-4" onClick={handleClick}>About</Link>
          {activeDropdown === "about" && (
            <ul className="absolute z-10  left-0 mt-2 bg-white text-gray-800 shadow-md w-48">
              ...
              <li><Link to="/about/reference-clients" className="block px-4 py-2 hover:bg-gray-200">Partners</Link></li>
            </ul>
          )}
        </li>
      ...
      {mobileMenuOpen && (
        <ul className="md:hidden flex flex-col bg-primary text-gray-300 p-4">
          <li className="flex justify-between items-center px-4 py-2 hover:bg-sky-800" onClick={() => toggleMobileDropdown("about")}> <Link to="/about">About</Link> <ChevronDown /></li>
          {mobileDropdown === "about" && (
            <ul className="pl-6">
              <li><Link to="/about/short-history" className="block py-2 hover:bg-sky-600">Short History</Link></li>
